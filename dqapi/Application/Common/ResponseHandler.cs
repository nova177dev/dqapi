...
//        public ActionResult<ExpressResponse> HandleResponse(ExpressResponse entity)
//        {
//            return entity.ResponseCode switch
//            {
//                200 => new OkObjectResult(entity),
//                201 => new CreatedResult("", entity),
//                401 => new UnauthorizedObjectResult(new ErrorMessage { TraceUuid = entity.TraceUuid, ResponseCode = 401, ResponseMessage = "Unauthorized" }),
//                404 => new NotFoundObjectResult(new ErrorMessage { TraceUuid = entity.TraceUuid, ResponseCode = 404, ResponseMessage = "Not Found" }),
//                _ => new BadRequestObjectResult(new ErrorMessage { TraceUuid = entity.TraceUuid, ResponseCode = StatusCodes.Status400BadRequest, ResponseMessage = entity.ResponseMessage ??= "Bad Request" })
//            };
//        }
